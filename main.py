...
class App:
    ...
    def Draw(self):
        ...
        while True:
            ...
            pg.draw.rect(self.sc, pg.Color('red'), self.get_rect(28, 0), border_radius=self.TITLE // 100)
            pg.draw.rect(self.sc, pg.Color('white'), self.get_rect(27, 0), border_radius=self.TITLE // 100)
